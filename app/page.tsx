    ...
    <main className="space-y-8">
      <section className="space-y-6">
        <div className="space-y-2">
          <h1 className="text-5xl font-mono font-bold tracking-tight pixelated">
            Mohitsingh Thakur
          </h1>
          <div className="text-lg text-white/80 font-mono">$ whoami</div>
        </div>

        <div className="space-y-4 max-w-3xl">
          <div className="text-white/90 font-mono text-lg leading-tight">
          ...
          <div className="text-white/90 font-mono text-lg leading-tight">
            Curiosity keeps me building, mistakes keep me learning, and clean
            architecture keeps me sane.
          </div>
        </div>
      </section>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
              ...
              <div className="pl-4 space-y-1 text-white/60 font-mono text-sm">
